...
public class Status {
  ...
  public boolean isOk() { return (code == Code.kOk.value); }

  public boolean isNotOk() { return (code != Code.kOk.value); }

  // Returns true iff the status indicates a NotFound error.
  public boolean isNotFound() { return code == Code.kNotFound.value; }

  // Returns true iff the status indicates a Corruption error.
  public boolean isCorruption() { return code == Code.kCorruption.value; }

  // Returns true iff the status indicates an IOError.
  public boolean isIOError() { return code == Code.kIOError.value; }

  // Returns true iff the status indicates a NotSupportedError.
  public boolean isNotSupportedError() { return code == Code.kNotSupported.value; }

  // Returns true iff the status indicates an InvalidArgument.
  public boolean isInvalidArgument() { return code == Code.kInvalidArgument.value; }
